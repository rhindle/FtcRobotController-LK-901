...
//@Disabled
public class ZZ_TestBot_LED_CS_Neo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        neo = hardwareMap.get(AdafruitNeoDriver.class, "neo");
            ...
            if (distance > 2) { //no pixel
                ...
                switch (ledmode) {
                    case 1: { // map rgb directly to qled
                        ...
                        neo.fill(Color.rgb(red, green, blue));
                        neo.show();
                        break;
                    }
