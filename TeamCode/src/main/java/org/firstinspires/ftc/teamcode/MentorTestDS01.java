...
//      TelemetryMgr.enableCategories(new TelemetryMgr.Category[] {Category.AUTODRIVE});
   ...
   private void addTelemetryLoopEnd() {
      TelemetryMgr.message(Category.CONTROLS, "speed ", JavaUtil.formatNumber(parts.controls.driveData.driveSpeed, 2));
      TelemetryMgr.message(Category.CONTROLS, "angle ", JavaUtil.formatNumber(parts.controls.driveData.driveAngle, 2));
      TelemetryMgr.message(Category.CONTROLS, "rotate", JavaUtil.formatNumber(parts.controls.driveData.rotate, 2));
