...
public class AdafruitNeoDriverImpl0 extends I2cDeviceSynchDeviceWithParameters<I2cDeviceSynch, AdafruitNeoDriverImpl0.Parameters>
        implements AdafruitNeoDriver0, I2cAddrConfig, OpModeManagerNotifier.Notifications {
   ...
   public AdafruitNeoDriverImpl0(I2cDeviceSynch deviceClient, boolean deviceClientIsOwned) {
      this(deviceClient, deviceClientIsOwned, new Parameters());
   }

   protected AdafruitNeoDriverImpl0(I2cDeviceSynch i2cDeviceSynch, boolean deviceClientIsOwned, @NonNull Parameters defaultParameters) {
   ...
   protected boolean internalInitialize(@NonNull Parameters parameters) {
      ...
      // I can't get this to work without a delay here.
      sleep(350);
